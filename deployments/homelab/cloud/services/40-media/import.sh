...
# Normalize every existing album idempotently. The albumclean import hooks
# apply the same conservative rules to new MusicBrainz matches before Beets
# performs duplicate detection, writes tags, or chooses the final path.
"$beet" albumclean
